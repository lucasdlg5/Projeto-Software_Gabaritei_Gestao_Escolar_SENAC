...
namespace gabaritei
{
    public partial class frm_cadastro_aluno_responsavel : Form
    {
        public frm_cadastro_aluno_responsavel()
        {
            InitializeComponent();
        }
        ...
        private void cadastro_alu_certo_Load(object sender, EventArgs e)
        {
            ...
            // TODO: This line of code loads data into the 'gABARITEIDataSet1.View_tipo_telefone_responsavel' table. You can move, or remove it, as needed.
            this.view_tipo_telefone_responsavelTableAdapter.Fill(this.gABARITEIDataSet1.View_tipo_telefone_responsavel);
            ...
            //txb_codigo_aluno_cad_aluno.Text = classe_PUBLICA.v_alunocd4;
            alunoBindingSource.Filter = "alu_cd  = " + classe_PUBLICA.v_alunocd4;

            //if (classe_PUBLICA.v_alunocd4 == "0")
            //{

            telefoneresponsavelBindingSource.AddNew();
            alunoreponsavelBindingSource.AddNew();
            ...
            //    txb_codigo_aluno_cad_aluno.Text = classe_PUBLICA.v_alunocd4;
            //    alunoreponsavelBindingSource.Filter = "alu_cd  = " + classe_PUBLICA.v_alunocd4;

            //    //alunoBindingSource.Filter = "[Nome do aluno]  = " + classe_PUBLICA.v_alunocd4;
            ...
            //    //tipotelefoneBindingSource.Filter = "tp_cd =" + classe_PUBLICA.v_alunocd;
            ...
            //   // textBox4.Text = classe_PUBLICA.v_alunocd4;
        ...
        private void btn_salvar_cad_aluno_Click_1(object sender, EventArgs e)
        {
            ...
            //alunoreponsavelBindingSource.EndEdit();
            //aluno_reponsavelTableAdapter.Update(GABARITEIDataSet);
            //aluno_reponsavelTableAdapter.Fill(GABARITEIDataSet.aluno_reponsavel);
            //alunoreponsavelBindingSource.AddNew();
        ...
        private void btn_cancelar_cad_aluno_Click(object sender, EventArgs e)
        {
            ...
            tbmatriculaBindingSource.EndEdit();
            tb_matriculaTableAdapter.Update(GABARITEIDataSet);
            tb_matriculaTableAdapter.Fill(GABARITEIDataSet.tb_matricula);
        ...
        private void textBox4_TextChanged(object sender, EventArgs e)
        {
            ...
            //this.view_cadastro_respTableAdapter.Fill(this.GABARITEIDataSet.view_cadastro_resp);
            //viewcadastrorespBindingSource.Filter = "alu_cd = " + classe_PUBLICA.v_alunocd4;
        ...
        {
            //textBox8.Text = txb_codigo_aluno_cad_aluno.Text;
            telefoneresponsavelBindingSource.EndEdit();
            telefone_responsavelTableAdapter.Update(GABARITEIDataSet);
            this.view_tipo_telefone_responsavelTableAdapter.Fill(this.GABARITEIDataSet.View_tipo_telefone_responsavel);
            viewtipotelefoneresponsavelBindingSource.Filter = "resp_cd = " + v_teste1;
        ...
        private void dataGridView1_SelectionChanged(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                textBox3.Text = dataGridView1.SelectedRows[0].Cells[3].Value.ToString();
                v_teste1 = dataGridView1.SelectedRows[0].Cells[3].Value.ToString();

                classe_PUBLICA.v_dvrespcd = dataGridView1.SelectedRows[0].Cells[3].Value.ToString();
            }
        ...
        {
            textBox2.Text = txb_codigo_aluno_cad_aluno.Text;
            alunotelefoneBindingSource.EndEdit();
            aluno_telefoneTableAdapter.Update(GABARITEIDataSet);
            ...
            //alunoBindingSource.EndEdit();
            //alunoTableAdapter.Update(GABARITEIDataSet);
            //string v_codigo2 = textBox2.Text;
            //alunoTableAdapter.Fill(GABARITEIDataSet.aluno);
            //int v_posicao2 = alunotelefoneBindingSource.Find("alu_cd", textBox2.Text);
            //alunoBindingSource.Position = v_posicao2;
            //alunoBindingSource.AddNew();
        }
        ...
        {
            textBox5.Text = txb_codigo_aluno_cad_aluno.Text;
            ...
            aluno_reponsavelTableAdapter.Fill(GABARITEIDataSet.aluno_reponsavel);
            alunoreponsavelBindingSource.AddNew();
            view_cadastro_respTableAdapter.Fill(GABARITEIDataSet.view_cadastro_resp);
            viewcadastrorespBindingSource.Filter = "alu_cd  = " + classe_PUBLICA.v_alunocd4;
        ...
        {
            string v_codigo = "0";
            if (txb_codigo_aluno_cad_aluno.Text != "")
            {
                v_codigo = txb_codigo_aluno_cad_aluno.Text;
            }

            viewcadastrorespBindingSource.Filter = "alu_cd  = " + v_codigo;
            //viewtipotelefoneresponsavelBindingSource.Filter = "tp_cd  = " + v_codigo;
            alunotelefoneBindingSource.Filter = "alu_cd =" + v_codigo;
